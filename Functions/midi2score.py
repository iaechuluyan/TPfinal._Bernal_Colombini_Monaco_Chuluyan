...
def m2f(midi_note: int, freq_la4: int = 440) -> float: #uso el que hice o este sivre? mepa q este es para la nota de sonido
...
def freq2cypher(frequency: float, notes) -> Optional[str]:
...
def convert_midi(ofile: str, midifile: str, tracks = None) -> None:
...
def load_midi(filepath: str) -> IO: #aca le damos la midi filee
